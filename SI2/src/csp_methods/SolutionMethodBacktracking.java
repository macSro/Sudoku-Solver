...
public class SolutionMethodBacktracking extends SolutionMethod{
    ...
    public SolutionMethodBacktracking(HeuristicVariable heuristicVariable, HeuristicDomain heuristicDomain){
